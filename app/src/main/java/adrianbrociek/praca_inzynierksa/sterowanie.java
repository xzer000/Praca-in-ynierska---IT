...
public class sterowanie extends Activity {
    public class FeedData {
        public FeedData( String data1, String data2, String data3, String data4) {
            last_data1 = data1;
            last_data2 = data2;
            last_data3 = data3;
            last_data4 = data4;
    ...
    FeedData mFD = new FeedData("0","0","0","0");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button5.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View arg0) {
                new AlertDialog.Builder(sterowanie.this)
                        .setTitle( "Koniec" )
    ...
    protected void updateResults() {
        ...
        sb.append("Pokarm: " + mFD.last_data1+ "\n");
        sb.append("Oświetlenie: " + mFD.last_data2+ "\n");
        sb.append("Wentylacja: " + mFD.last_data3+ "\n");
        sb.append("Ogrzewanie: " + mFD.last_data4+ "\n");
        responseView.setText(sb);

    }

    private void startProgressBar() {
        progress = ProgressDialog.show(sterowanie.this, "", "Pobieranie danych...", true);
    }
    private void stopProgressBar() {
        progress.cancel();
    }

    private sterowanie.FeedData sendRequest() {
        FeedData fd = new FeedData("0","0","0","0");
        DefaultHttpClient httpClient = new DefaultHttpClient();
        HttpGet httpGet = new HttpGet("https://thingspeak.com/channels/"+"20412"+"/feeds/last.json");
        try {
            HttpResponse response = httpClient.execute(httpGet);
            BufferedReader br = new BufferedReader(new InputStreamReader(response.getEntity().getContent()));
            JSONObject jo = new JSONObject(br.readLine());
            String attr1 = jo.getString("field4");
            String attr2 = jo.getString("field5");
            String attr3 = jo.getString("field6");
            String attr4 = jo.getString("field7");
            fd.last_data1 = attr1;
            fd.last_data2 = attr2;
            fd.last_data3 = attr3;
            fd.last_data4 = attr4;
